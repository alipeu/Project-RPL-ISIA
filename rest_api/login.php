<?php
  ...
  $query_login = mysqli_query($connect, "SELECT userid, nama_mhs, nim, mayor, semester, ipk, ukt, alamat, telepon FROM mahasiswa WHERE userid='$userid' AND password='$pass_encrypt'");
